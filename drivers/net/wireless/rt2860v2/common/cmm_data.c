...
/*
	...
	========================================================================
*/
extern INT32 RT6352_SkuCalculateTxPwrAdj(struct _RTMP_ADAPTER *ad,PTXWI_STRUC pTxwi);
VOID RTMPWriteTxWI(
	IN	PRTMP_ADAPTER	pAd,
...
#ifdef SINGLE_SKU_V2	
	pTxWI->TxPwrAdj= RT6352_SkuCalculateTxPwrAdj(pAd,pTxWI); 
#endif /* SINGLE_SKU_V2 */
